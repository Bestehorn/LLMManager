...
class TestJSONModelSerializer:
    ...
    def test_serialize_to_file_custom_formatting(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.custom_serializer.serialize_to_file(catalog=self.mock_catalog, output_path=output_path)
    ...
    def test_serialize_dict_to_file_serialization_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('src.bedrock.serializers.json_serializer.logging.getLogger') as mock_logger:
                ...
                with pytest.raises(TypeError, match="JSON serialization failed"):
                    serializer.serialize_dict_to_file(data=unserializable_data, output_path=output_path)
