...
class TestContentFilter:
    ...
    def setup_method(self):
        ...
        self.sample_request_with_image = {
            ...
            ConverseAPIFields.INFERENCE_CONFIG: {
                ConverseAPIFields.MAX_TOKENS: 1000
            }
        }
                    ...
                    ConverseAPIFields.CONTENT: [
                        ...
                        },
                        {
                            ConverseAPIFields.IMAGE: {
                                ...
                                ConverseAPIFields.SOURCE: {
                                    ConverseAPIFields.BYTES: "image_data"
                                }
                            }
                        },
                        {
    ...
    def test_restore_features(self):
        ...
        restored_request = self.content_filter.restore_features(
            filter_state=filter_state,
            features_to_restore={'image_processing'}
        )
...
class TestContentFilterIntegration:
    ...
    def test_image_restoration_scenario(self):
        ...
        content_blocks = filtered_for_text_model[ConverseAPIFields.MESSAGES][0][ConverseAPIFields.CONTENT]
        ...
        restored_for_multimodal = self.content_filter.restore_features(
            filter_state=filter_state,
            features_to_restore=features_to_restore
        )
        
        # Verify image is restored
        content_blocks = restored_for_multimodal[ConverseAPIFields.MESSAGES][0][ConverseAPIFields.CONTENT]
        ...
        assert image_block[ConverseAPIFields.IMAGE][ConverseAPIFields.FORMAT] == "jpeg"
        assert text_block[ConverseAPIFields.TEXT] == "Please analyze this image and tell me what you see."
