...
class TestCRISManagerRefreshData:
    ...
    def test_refresh_cris_data_success(self, mock_datetime, temp_dir):
        ...
        # Setup mock returns
        mock_models_dict = {
            "Claude 3.5 Sonnet": Mock(spec=CRISModelInfo)
        }
...
class TestCRISManagerLoadCachedData:
    ...
    def test_load_cached_data_success(self, temp_dir):
        ...
        manager._serializer.load_from_file.assert_called_once_with(input_path=manager.json_output_path)
...
class TestCRISManagerQueryMethods:
    ...
    def setup_method(self):
        ...
        self.mock_catalog.get_models_by_source_region.return_value = {"test_model": self.mock_model_info}
        self.mock_catalog.get_models_by_destination_region.return_value = {"test_model": self.mock_model_info}
    ...
    def test_get_models_by_source_region_success(self):
        ...
        self.mock_catalog.get_models_by_source_region.assert_called_once_with(source_region="us-east-1")
    ...
    def test_get_models_by_destination_region_success(self):
        ...
        assert result == {"test_model": self.mock_model_info}
        self.mock_catalog.get_models_by_destination_region.assert_called_once_with(destination_region="us-west-2")
    ...
    def test_get_inference_profile_for_model_success(self):
        ...
        self.mock_catalog.get_inference_profile_for_model.assert_called_once_with(model_name="test_model")
    ...
    def test_get_destinations_for_source_and_model_success(self):
        ...
        assert result == ["us-west-2"]
        self.mock_model_info.get_destinations_for_source.assert_called_once_with(source_region="us-east-1")
...
class TestCRISManagerPrivateMethods:
    ...
    def test_download_documentation(self):
        ...
        manager._downloader.download.assert_called_once_with(
            url=manager.documentation_url,
            output_path=manager.html_output_path
        )
    ...
    def test_save_catalog_to_json(self):
        ...
        manager._serializer.serialize_dict_to_file.assert_called_once_with(
            data={"test": "data"},
            output_path=manager.json_output_path
        )
