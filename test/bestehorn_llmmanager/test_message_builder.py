...
class TestAddImageBytesMethod:
    ...
    def test_add_image_with_explicit_format(self):
        ...
        result = builder.add_image_bytes(
            bytes=image_data,
...
class TestAddDocumentBytesMethod:
    ...
    def test_add_document_with_explicit_format(self):
        ...
        assert doc_block[ConverseAPIFields.DOCUMENT][ConverseAPIFields.SOURCE][ConverseAPIFields.BYTES] == pdf_data
...
class TestBuildMethod:
    ...
    def test_build_complex_message(self):
        ...
        builder.add_text(text="Please analyze these files:")\
               ...
               .add_text(text="What do you think?")
...
class TestMethodChaining:
    ...
    def test_method_chaining(self):
        ...
        result = builder.add_text(text="First text")\
                        .add_image_bytes(bytes=image_data, format=ImageFormatEnum.JPEG)\
