...
class TestModelCRISCorrelator:
    ...
    def sample_model_catalog(self, sample_bedrock_model: BedrockModelInfo) -> ModelCatalog:
        ...
        return ModelCatalog(
            ...
            models={"claude-3-sonnet": sample_bedrock_model}
        )
    ...
    def test_init_default_fuzzy_matching(self):
        ...
        assert correlator._fuzzy_matching_enabled == ModelCorrelationConfig.ENABLE_FUZZY_MATCHING_DEFAULT
    ...
    def test_correlate_catalogs_empty_catalogs(self, correlator: ModelCRISCorrelator):
        ...
        empty_model_catalog = ModelCatalog(
            retrieval_timestamp=datetime.now(),
            models={}
        )
        empty_cris_catalog = CRISCatalog(
            retrieval_timestamp=datetime.now(),
            cris_models={}
        )
        ...
        result = correlator.correlate_catalogs(
            ...
            cris_catalog=empty_cris_catalog
        )
    ...
    def test_correlate_catalogs_cris_processing_error(
        ...
        with patch.object(correlator, '_create_cris_only_unified_model', side_effect=Exception("CRIS error")):
    ...
    def test_create_model_name_mapping(self, correlator: ModelCRISCorrelator, sample_cris_model: CRISModelInfo):
    ...
    def test_find_matching_cris_model_fuzzy_enabled(
        self,
        correlator_fuzzy_enabled: ModelCRISCorrelator,
        sample_cris_model: CRISModelInfo
    ):
    ...
    def test_find_matching_cris_model_fuzzy_disabled(
        self,
        correlator_fuzzy_disabled: ModelCRISCorrelator,
        sample_cris_model: CRISModelInfo
    ):
