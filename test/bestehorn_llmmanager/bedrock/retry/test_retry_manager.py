...
class TestRetryManagerContentFiltering:
    ...
    def test_execute_with_retry_image_restoration(self):
        ...
        result, attempts, warnings = self.retry_manager.execute_with_retry(
            operation=mock_operation, operation_args=self.image_request, retry_targets=retry_targets
        )
    ...
    def test_feature_fallback_on_same_model(self):
        ...
        retry_targets = [("Test Model", "us-east-1", self.text_model_access)]
    ...
    def test_multiple_content_types_restoration(self):
        ...
        result, attempts, warnings = self.retry_manager.execute_with_retry(
            operation=mock_operation, operation_args=multimodal_request, retry_targets=retry_targets
        )
    ...
    def test_filter_state_preservation(self):
        ...
        retry_targets = [("Claude 3.5 Sonnet", "us-east-1", self.multimodal_model_access)]
    ...
    def test_text_only_requests_unchanged(self):
        ...
        text_request = {
            ConverseAPIFields.MESSAGES: [
                {
                    ConverseAPIFields.ROLE: ConverseAPIFields.ROLE_USER,
                    ConverseAPIFields.CONTENT: [{ConverseAPIFields.TEXT: "Hello, how are you?"}],
                }
            ]
        }
        ...
        result, attempts, warnings = self.retry_manager.execute_with_retry(
            operation=mock_operation, operation_args=text_request, retry_targets=retry_targets
        )
    ...
    def test_existing_retry_logic_preserved(self):
        ...
        text_request = {
            ConverseAPIFields.MESSAGES: [
                {
                    ConverseAPIFields.ROLE: ConverseAPIFields.ROLE_USER,
                    ConverseAPIFields.CONTENT: [{ConverseAPIFields.TEXT: "Test message"}],
                }
            ]
        }
