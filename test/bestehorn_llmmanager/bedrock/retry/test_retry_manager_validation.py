...
from src.bedrock.models.llm_manager_structures import (
    RetryConfig, RetryStrategy, RequestAttempt, ResponseValidationConfig,
    ValidationResult, ValidationAttempt, BedrockResponse
)
from src.bedrock.models.llm_manager_constants import (
    ConverseAPIFields, ResponseValidationLogMessages
)
...
class TestResponseValidation:
    ...
    def test_validation_function_exception_handling(self):
        ...
        validation_config = ResponseValidationConfig(
            response_validation_function=buggy_validation_function,
            response_validation_retries=2
        )
    ...
    def test_bedrock_response_validation_methods(self):
        ...
        response.validation_attempts = [
            ValidationAttempt(
                ...
                failed_content="invalid content"
            ),
            ValidationAttempt(
                attempt_number=2,
