...
class TestFileTypeDetectorInitialization:
    ...
    def test_initialization(self):
        ...
        assert (
            detector._logger.name
            == "bestehorn_llmmanager.util.file_type_detector.file_type_detector"
        )
...
class TestVideoDetection:
    ...
    def test_detect_webm_by_content_no_extension(self):
        ...
        detection_result = detector.detect_video_format(content=webm_content)

        assert detection_result.is_successful
        assert detection_result.detected_format == "webm"  # Default when no extension
...
class TestCombineDetectionResults:
    ...
    def test_combine_results_agreement(self):
        ...
        combined = detector._combine_detection_results(
            extension_result=extension_result, content_result=content_result, filename="test.jpg"
        )
    ...
    def test_combine_results_content_only(self):
        ...
        combined = detector._combine_detection_results(
            extension_result=None, content_result=content_result, filename="test"
        )
    ...
    def test_combine_results_extension_only(self):
        ...
        combined = detector._combine_detection_results(
            extension_result=extension_result, content_result=None, filename="test.jpg"
        )
    ...
    def test_combine_results_no_detection(self):
        ...
        combined = detector._combine_detection_results(
            extension_result=None, content_result=None, filename="test.unknown"
        )
