...
from .access_method import ModelAccessMethod, ModelAccessInfo
from .unified_constants import UnifiedJSONFields, ModelCorrelationConstants
...
class UnifiedModelInfo:
    ...
    def get_direct_access_regions(self) -> List[str]:
        ...
        """
        return sorted([
            region for region, access_info in self.region_access.items()
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Union[str, List[str], bool, Dict, None]]) -> 'UnifiedModelInfo':
        """
        ...
        try:
            ...
            inference_params_link = str(inference_params_raw) if inference_params_raw is not None else None
...
class UnifiedModelCatalog:
    ...
    def get_models_by_provider(self, provider: str) -> Dict[str, UnifiedModelInfo]:
        ...
        """
        return {
            name: info for name, info in self.unified_models.items()
