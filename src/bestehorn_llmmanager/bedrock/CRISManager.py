...
class CRISManager:
    ...
    def load_cached_data(self) -> Optional[CRISCatalog]:
        ...
        try:
            ...
            self._cached_catalog = catalog
            self._logger.info(
                CRISLogMessages.CACHE_LOADED.format(file_path=self.json_output_path)
            )
            return catalog
    ...
    def get_models_by_destination_region(self, destination_region: str) -> Dict[str, CRISModelInfo]:
        ...
        return self._cached_catalog.get_models_by_destination_region(destination_region=destination_region)
    ...
    def _download_documentation(self) -> None:
        ...
        self._downloader.download(
            ...
            output_path=self.html_output_path
        )
        self._logger.info(
