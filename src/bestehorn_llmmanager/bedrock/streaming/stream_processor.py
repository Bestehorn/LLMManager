...
class StreamProcessor:
    ...
    def create_streaming_iterator(
        ...
        try:
            for event in event_stream:
                ...
                if content:
                    self._logger.debug(
                        StreamingLogMessages.STREAM_CONTENT_CHUNK.format(
    ...
    def _process_single_event(
        ...
        self._logger.debug(
            StreamingLogMessages.STREAM_EVENT_RECEIVED.format(event_type=event_type)
        )
    ...
    def build_recovery_context(
        ...
        continuation_message = {
            "role": "user", 
            "content": [{"text": continuation_text}]
        }
