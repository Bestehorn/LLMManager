...
class StreamEventHandler:
    ...
    def handle_metadata(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self._logger.debug(f"Received metadata: {token_usage.get('total_tokens', 0)} tokens, "
    ...
    def handle_error_event(self, event: Dict[str, Any], event_type: StreamingEventTypes) -> Dict[str, Any]:
        """
    ...
    def get_event_handler(self, event_type: StreamingEventTypes):
        """
