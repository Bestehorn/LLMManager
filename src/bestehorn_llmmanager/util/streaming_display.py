...
class StreamingDisplayFormatter:
    ...
    def display_streaming_summary(
        ...
        print(f"📝 Content: {content_length} characters, {len(streaming_response.content_parts)} parts")
    ...
    def display_recovery_information(
        self,
        streaming_response: StreamingResponse,
        title: str = "Recovery Information"
    ) -> None:
        """
        ...
        if mid_stream_exceptions:
            ...
            for i, exc in enumerate(mid_stream_exceptions, 1):
                ...
                print(f"     {i}. {exc['error_type']} at position {exc['position']} "
...
def display_streaming_summary(
    ...
    """
    formatter = StreamingDisplayFormatter()
    formatter.display_streaming_summary(
        streaming_response=streaming_response,
        title=title
    )
...
def display_recovery_information(
    ...
    """
    formatter = StreamingDisplayFormatter()
    formatter.display_recovery_information(
        streaming_response=streaming_response,
        title=title
    )
