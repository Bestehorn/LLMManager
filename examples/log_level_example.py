...
def demo_log_levels():
    ...
    print("-" * 50)
    LLMManager(models=["Claude 3 Haiku"], regions=["us-east-1"], log_level=logging.INFO)
    ...
    print("-" * 50)
    LLMManager(
        models=["Claude 3 Haiku"], regions=["us-east-1"], log_level="ERROR"  # Can use string
    )
    ...
    print("-" * 50)
    LLMManager(models=["Claude 3 Haiku"], regions=["us-east-1"], log_level=logging.DEBUG)
